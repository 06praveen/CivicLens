...
function BudgetVideoPlayer({
  ...
  return (
    <div className="relative aspect-video w-full rounded-sm overflow-hidden border border-rule bg-black shadow-sm group">
      {playing ? (
...
// ── Main Section with Video on Left & Summary on Right ──────────────────────
export function BudgetYearSection() {
  ...
  const currentItem = BUDGET_YEARS_DATA[activeIndex];

  return (
    <section
      className="bg-white border-y border-rule py-12 mb-12"
      aria-label="Union Budget — Parliament Speeches Overview"
    >
      <div className="portal-container">
        ...
        <div className="border-b-2 border-institutional/20 pb-3 pt-2 mb-3 flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs font-bold font-mono text-institutional/80 bg-ivory px-3 py-1 border border-rule rounded">
        ...
        <p className="text-sm text-muted-foreground mb-6 leading-relaxed">
          Watch the official Union Budget speech on the left and review key highlights on the right.
        </p>

        {/* ── Active Slide Container ── */}
        <div className="border border-rule rounded-sm bg-white shadow-xs p-4 sm:p-6 lg:p-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center gap-2.5">
              ...
              <BudgetVideoPlayer item={currentItem} />
            ...
            <div className="lg:col-span-5 flex flex-col justify-between bg-ivory/60 p-5 sm:p-6 border border-rule rounded-sm">
              <div>
                ...
                <ul className="space-y-3 mb-6">
                  {currentItem.summary.map((point, pIdx) => (
                    <li
                      key={pIdx}
